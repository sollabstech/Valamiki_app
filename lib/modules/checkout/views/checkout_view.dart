      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const _SectionTitle(title: 'Delivery Address', icon: Icons.location_on_rounded),
            ...
            // Payment method
            const _SectionTitle(title: 'Payment Method', icon: Icons.payment_rounded),
            const SizedBox(height: 12),
            Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.credit_card_rounded, color: AppColors.textHint, size: 22),
